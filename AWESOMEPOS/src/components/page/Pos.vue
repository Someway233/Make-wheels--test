    ...
    <el-row>
      ...
      <el-col :span='7' class="pos-order" id="order-list">
        ...
        <el-tabs>
         ...
         <div class="totalDiv">
          <small>数量:</small>{{totalCount}}<span class="totalDiv-right"> <small>金额:</small>{{totalMoney}}元</span>
         </div>
         <div class="div-btn">
...
.often-goods-list ul li {
  ...
  border: 1px solid rgb(75, 104, 161);
...
.foodName {
  font-family: "Micosof", "Avenit", Helvetica, Arial, sans-serif;
  font-size: 16px;
